...
以下内容来自论文历史稿，由 `gpt-6-luna` 使用 Thesis Craft 完成审查和润色。案例展示的是从发现问题到解决问题的完整动作。
...
下载并解压 [thesis-craft-0.6.1.zip](https://github.com/Michaeloan/thesis-craft/raw/refs/heads/main/dist/thesis-craft-0.6.1.zip)，将其中的 `thesis-craft` 文件夹复制到 Codex 的 Skills 目录：
...
源码包：[thesis-craft-0.6.1-source.zip](https://github.com/Michaeloan/thesis-craft/raw/refs/heads/main/dist/thesis-craft-0.6.1-source.zip)。
